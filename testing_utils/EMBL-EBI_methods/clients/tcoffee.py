...
# python tcoffee.py --email dk0stenko@yandex.ru --stype protein --format fasta_aln --order input --outfile TestAlign --quiet ~/Desktop/BaliBase/BAliBASE_R10/RV100/BBA0002.tfa